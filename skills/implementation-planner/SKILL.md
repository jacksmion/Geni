...
description: A powerful skill for breaking down complex goals into a structured implementation plan and tracking progress.
version: 1.0.0
---

# Implementation Planner

This skill empowers the agent to behave like a senior engineer who plans before coding. It provides tools to create, track, and manage a structured implementation plan.
