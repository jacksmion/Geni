...
export const AuthorizationModal: React.FC = () => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="w-full max-w-lg bg-[#1e1e1e] border border-white/10 rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                {/* Header */}
                <div className="px-6 py-4 border-b border-white/5 bg-gradient-to-r from-amber-500/10 to-orange-500/10 flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="text-lg font-semibold text-white">工具执行确认</h3>
                        <p className="text-xs text-amber-500/80 font-medium uppercase tracking-wider">高风险操作拦截</p>
                    </div>
                </div>
                ...
                <div className="p-6 space-y-4">
                    <div className="space-y-2">
                        <label className="text-xs font-semibold text-gray-500 uppercase">请求执行工具</label>
                    ...
                    <div className="space-y-2">
                        <label className="text-xs font-semibold text-gray-500 uppercase">执行参数</label>
                    ...
                    <div className="bg-amber-500/5 border border-amber-500/20 rounded-xl p-4 flex gap-3">
                        ...
                        <div className="text-sm">
                            ...
                            <p className="text-amber-200/60 leading-relaxed mt-1">{authRequest.reason}</p>
                        </div>
                    </div>
                </div>
