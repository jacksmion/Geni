...
export class SessionController {
    ...
    private async handleSave(event: IpcMainInvokeEvent, updates: { id: string; title?: string; staffId?: string; modelId?: string; workspacePath?: string; activeSkillIds?: string[] }) {
        ...
        const patch: { title?: string; staffId?: string; modelId?: string; workspacePath?: string; activeSkillIds?: string[] } = {};
