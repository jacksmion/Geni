...
export class SessionController {
    ...
    private async handleSave(event: IpcMainInvokeEvent, updates: { id: string; title?: string; staffId?: string; modelId?: string; workspacePath?: string; activeSkillIds?: string[]; pinned?: boolean }) {
        ...
        const patch: { title?: string; staffId?: string; modelId?: string; workspacePath?: string; activeSkillIds?: string[]; pinned?: boolean } = {};
        ...
        if (updates.activeSkillIds !== undefined) patch.activeSkillIds = updates.activeSkillIds;
